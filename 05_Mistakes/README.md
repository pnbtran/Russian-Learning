...
- Vocabulary mistakes (Lỗi từ vựng).
- Pronunciation mistakes (Lỗi phát âm).
- Translation mistakes (Lỗi dịch).
- Writing mistakes (Lỗi viết).
- Corrections and explanations (Cách sửa và giải thích).
...
- General practice exercises (Bài luyện tập thông thường). 
